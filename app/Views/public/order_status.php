  ...
  <style>
    ...
    *::after {
    ...
    .status-icon {
      ...
      z-index: 1;
      position: relative;
      box-shadow: 0 0 0 8px rgba(255, 107, 53, .15)
    }
    ...
    @keyframes glow {
      ...
      to {
        box-shadow: 0 0 0 20px rgba(34, 197, 94, .3)
      }
    }
  ...
  <script>
    ...
    function applyStatus(data) {
      ...
      if (data.status === 'cancelled') {
        ...
        document.getElementById('sIcon').classList.remove('green');

        document.getElementById('sLabel').textContent = 'Order Cancelled';
        document.getElementById('sMsg').textContent =
          'Sorry, your order has been cancelled by the restaurant.';
        ...
        <div class="action-btn"
             style="background:#EF4444;color:#fff;cursor:default;">
