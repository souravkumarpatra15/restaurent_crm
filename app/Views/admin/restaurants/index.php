...
<div style="padding:0 1rem">
  ...
  <div class="card">
    <div class="table-wrap">
      <table class="table">
        <thead><tr><th>Restaurant</th><th>Type</th><th>Plan</th><th>Status</th><th>Actions</th></tr></thead>
        <tbody>
          <?php if (empty($restaurants)): ?>
          <tr><td colspan="5"><div class="empty-state"><i class="fa fa-store"></i><p>No restaurants yet</p></div></td></tr>
          ...
          <tr>
            ...
            <td><?= ucfirst(str_replace('_',' ',$r['restaurant_type'])) ?></td>
            ...
            <td>
              ...
              <button onclick="if(confirm('Login as this admin?')){let f=document.createElement('form');f.method='POST';f.action='<?= base_url('super/restaurants/login-as/') ?><?= $r['id'] ?>';f.innerHTML='<?= csrf_field() ?>';document.body.appendChild(f);f.submit()}" class="btn btn-sm btn-outline"><i class="fa fa-right-to-bracket"></i></button>
            </td>
          </tr>
