...
<head>
  ...
  <style>
    * {
    ...
    /* Hero */
    .hero {
      background: linear-gradient(135deg, #1A202C 0%, #2D3748 60%, #FF6B35 100%);
...
<body>
  ...
  <nav class="nav">
    <div class="nav-brand">
      <img src="https://www.dinovix.ngwebd.com/images/logo.png" alt="DinoviX Logo" class="nav-logo-img" style="width:140px;">
    </div>
    <div class="nav-links">
