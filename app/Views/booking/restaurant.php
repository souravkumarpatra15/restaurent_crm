...
<body>
  ...
  <div style="padding:0 1rem;max-width:520px;margin:0 auto">
    ...
    <div class="steps">
      ...
      <div class="step-card">
        ...
        <div id="slotArea">
          <div class="slots-loading"><i class="fa fa-spinner fa-spin"></i> Select date first</div>
        </div>
      </div>
  ...
  <script>
    ...
    function selectSlot(el, label) {
      ...
      document.getElementById('detailsCard').scrollIntoView({
        behavior: 'smooth',
        block: 'start'
      });
    }
    ...
    function updateSummary() {
      ...
      document.getElementById('sumSlot').textContent = selTime ? selTime.replace(/(\d+):(\d+):.*/, (_, h, m) => {
        const hh = parseInt(h);
