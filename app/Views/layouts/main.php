...
<head>
  ...
  <title><?= $title ?? 'RestOne' ?> — <?= $restaurantName ?? 'SaaS Restaurant Management' ?></title>
...
<body class="<?= $bodyClass ?? '' ?>">
  ...
  <header class="mobile-header" id="mobileHeader">
    ...
    <div class="mobile-logo">
      <img src="<?= base_url('images/logo.png') ?>" alt="RestOne" class="mobile-logo-img">
    </div>
  ...
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
      <div class="brand">
        <img src="<?= base_url('images/favicon.png') ?>" alt="RestOne" class="brand-logo">
